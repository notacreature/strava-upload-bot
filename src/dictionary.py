MESSAGES = {
    "key_activity": "Посмотреть в Strava",
    ...
    "reply_name": "🤖 Введи новое название.",
    "reply_other": "🤖 К сожалению, я не понимаю, что ты имеешь ввиду.\nПопробуй ввести команду /help.",
    "reply_published": "Активность опубликована 🏆",
    "reply_restart": "🤖 Мы уже знакомы. Но если ты хочешь переподключить меня к Strava, нажми кнопку ниже.",
    "reply_scopes": "🤖 Кажется, у меня не хватает прав, чтобы опубликовать активность. Пожалуйста, выполни команду /start еще раз.",
    ...
    "reply_updated": "Активность обновлена 🏆",
}
STATUSES = {
