TEXT = {
    ...
    "reply_scope": "🤖 Кажется, у меня не хватает прав, чтобы опубликовать активность. Пожалуйста, выполни команду /start еще раз.",
